...
class OptimizeRequest(BaseModel):
    ...
    """
    ข้ามเงื่อนไขเป้าเงินทั้งหมด (LP + ตัวเกลี่ยเงิน) กระจายด้วยสัดส่วนประวัติล้วน ๆ
    ตามกลยุทธ์ที่เลือก — yellow_target ที่ส่งมาจะถูกละเว้นโดยสมบูรณ์ไม่ว่าค่าจะเป็นอะไร

    ใช้กับโหมดทดลอง "กระจายจากประวัติ ไม่ต้องตั้งเป้าเงิน" — ค่าเริ่มต้น False คือ
    พฤติกรรมปกติของหน้าเว็บหลักที่ใช้งานจริงอยู่ทุกวันนี้ ไม่เปลี่ยนแปลงเลย
    """
