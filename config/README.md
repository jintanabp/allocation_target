...
> ทุกครั้งที่มี commit แตะไฟล์นี้ ค่าบนเซิร์ฟเวอร์จะถูกเขียนทับ — คนที่แอดมินเพิ่ง
> เพิ่มผ่านหน้าเว็บหลังจาก commit ล่าสุดจะหายไป (เกิดจริง 25–26 ส.ค. 2026)
>
> จึงต้อง **ดาวน์โหลดรายชื่อจากหน้าแอดมินเก็บไว้ทุกครั้งที่แก้** แล้วส่งให้ dev
> เอาเข้า git ก่อน deploy รอบถัดไป (ดู `docs/DEPLOY_QA_CHECKLIST.md` หมวด 10)
