...
>
> **แผนเอาไฟล์นี้ออกจาก git ถูกพักไว้** (25 ก.ย. 2026) — ถ้าจะทำต้องแยก 2 deploy ห้ามรวบ ไม่งั้น
> รายชื่อบนเซิร์ฟเวอร์หาย ดู `docs/next-plan-2026-09.md` หัวข้อ 16.9
>
> แอดมินหลายคนแก้ผู้ใช้บนเว็บพร้อมกันได้แล้ว (ไม่ทับกัน — `mutate_rows`) แต่สคริปต์ใน
> `scripts/access/` รันเป็นโปรเซสแยก ล็อกในแอปกันไม่ได้ **อย่ารันตอนมีแอดมินกำลังแก้ผู้ใช้**
