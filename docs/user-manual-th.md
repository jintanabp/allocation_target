...
## 7. ดูผลกระจายของทีมอื่น (Peer)

ถ้าสิทธิ์ `region_peers` หรือ Manager ดูหลาย SL:

- สลับ Supervisor ใน dropdown — ทีมที่ไม่ใช่ทีมตัวเองจะเป็น **โหมดดูอย่างเดียว** (โหลดเร็ว — แสดงเฉพาะผลกระจายจาก server ไม่ดึงข้อมูลพนักงานทั้งก้อน)
- แถบด้านบนแสดงว่าใครกระจายล่าสุด เมื่อไหร่ (จาก snapshot บน server)
- กระจายหีบและส่ง Target Sun ได้เฉพาะทีม home SL ของคุณ
- สลับกลับทีมตัวเองเพื่อโหลดข้อมูล Step 1–2 และแก้ไขได้ตามปกติ
